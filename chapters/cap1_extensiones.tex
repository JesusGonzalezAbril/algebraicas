...
\begin{proposition}{Caracterización de elemento algebraico}{prop_caracterizacion_algebraico}
...
Está claro que \(\mathrm{Min}_K(\alpha)\) es el único polinomio mónico de grado mínimo de \(I\). Del Lema \ref{lem:raices_irreducibles} se deduce que si \(\mathrm{Min}_K(\alpha)\) tiene grado \(n\), entonces \(1,\alpha ,\alpha^2,\ldots ,\alpha^{n - 1}\) es una base de \(K(\alpha) / K\). En resumen:
...
\begin{example}{Ejemplos de polinomios mínimos}{ej_minimos}
(1) \(\mathrm{Min}_{\mathbb{Q}}(\sqrt{2}) = X^2 - 2\), \(\mathrm{Min}_{\mathbb{R}}(\sqrt{2}) = X - \sqrt{2}\) y \(\mathrm{Min}_{\mathbb{Q}}(i) = \mathrm{Min}_{\mathbb{R}}(i) = X^2 +1\). Más generalmente, si \(q\in \mathbb{Q}\) y \(\sqrt{q}\notin \mathbb{Q}\), entonces \(\mathrm{Min}_{\mathbb{Q}}(\sqrt{q}) = X^2 - q\).

(2) Si \(\alpha = \sqrt{5 + \sqrt{5}}\), entonces \(\alpha^2 - 5 = \sqrt{5}\), con lo que \(5 = (\alpha^2 - 5)^2 = \alpha^4 - 10\alpha^2 + 25\), es decir \(\alpha\) es una raíz del polinomio \(X^4 - 10X + 20\). Aplicando el Criterio de Eisenstein a este polinomio para el primo 5, deducimos que es irreducible sobre \(\mathbb{Q}\) y por tanto \(\mathrm{Min}_{\mathbb{Q}}(\alpha) = X^4 - 10X + 20\).
...
Una consecuencia de la Proposición 1.12 es el siguiente corolario que caracteriza las extensiones finitas.

\begin{corollary}{Caracterización de extensiones finitas}{cor_caracterizacion_finitas}
Las siguientes condiciones son equivalentes para una extensión de cuerpos.

(1) \(L / K\) es finita.
(2) \(L / K\) es algebraica y finitamente generada.
(3) Existen \(\alpha_{1},\ldots ,\alpha_{n}\in L\) algebraicos sobre \(K\) tales que \(L = K(\alpha_{1},\ldots ,\alpha_{n})\).
\end{corollary}

\begin{proofbox}
(1) implica (2). Supongamos que \(L / K\) es finita. Entonces \([K(\alpha):K]\leq [L:K]< \infty\) para todo \(\alpha \in L\). De la Proposición 1.12 se deduce que \(\alpha\) es algebraico sobre \(K\). Por otro lado, si \(\alpha_{1},\ldots ,\alpha_{n}\) es una base de \(L_{K}\), entonces \(L = K(\alpha_{1},\ldots ,\alpha_{n})\) y por tanto \(L / K\) es finitamente generada.

(2) implica (3) es obvio.

(3) implica (1). Si \(\alpha_{1},\ldots ,\alpha_{n}\) satisfacen las condiciones de (3), entonces cada \(\alpha_{i}\) es algebraico sobre \(K(\alpha_{1},\ldots ,\alpha_{i - 1})\). Por tanto \(K(\alpha_{1},\ldots ,\alpha_{i}) / K(\alpha_{1},\ldots ,\alpha_{i - 1})\) es una extensión finita por el Lema 1.12. Aplicando que la clase de extensiones finitas es multiplicativa deducimos que \(L = K(\alpha_{1},\ldots ,\alpha_{n}) / K\) es finita.
\end{proofbox}

\begin{corollary}{Multiplicatividad de extensiones algebraicas}{cor_multiplicatividad_algebraicas}
La clase de extensiones algebraicas es multiplicativa.
\end{corollary}

\begin{proofbox}
Sea \(K\subseteq E\subseteq L\) una torre de extensiones. Es obvio que si \(L / K\) es algebraica entonces \(E / K\) y \(L / K\) son algebraicas. Recíprocamente, supongamos que \(E / K\) y \(L / E\) son algebraicas y sea \(\alpha \in L\). Entonces \(\alpha\) es algebraico sobre \(E\). Sea \(p = \mathrm{Min}_{E}(\alpha)\) y sean \(p_0,p_1,\ldots ,p_n\) los coeficientes de \(p\). Por hipótesis \(p_0,p_1,\ldots ,p_n\) que son algebraicos sobre \(K\), lo que implica que \(F = K(p_0,p_1,\ldots ,p_n) / K\) es finita, por el Corolario 1.15. Además, \(\alpha\) es algebraico sobre \(F\) y por tanto \(F(\alpha) / F\) es finita. Entonces \([K(\alpha):K]\leq [K(\alpha ,p_0,p_1,\ldots ,p_n):K] = [F(\alpha):F][F:K]< \infty\). De la Proposición 1.12 deducimos que \(\alpha\) es algebraico sobre \(K\).
\end{proofbox}

\begin{corollary}{Clausura algebraica}{cor_clausura_algebraica}
...
\begin{proofbox}
Obviamente \(K\subseteq C\). Si \(\alpha ,\beta \in C\), entonces \(\beta\) es algebraico sobre \(K(\alpha)\) y por tanto \(K(\alpha) / K\) y \(K(\alpha ,\beta) / K(\alpha)\), son algebraicas lo que implica que \(K(\alpha ,\beta) / K\) es también algebraica (Corolario 1.16). Por tanto todo elemento de \(K(\alpha ,\beta)\) es algebraico sobre \(K\) y en particular \(\alpha +\beta ,\alpha - \beta ,\alpha \beta \in C\) y, si \(\beta \neq 0\), entonces \(\beta^{-1}\in C\). Esto prueba que \(C\) es un subcuerpo de \(L\).
\end{proofbox}
...
\begin{proposition}{Cierre para levantamientos}{prop_cierre_levantamientos}
...
\begin{proofbox}
Sean \(L_{1} / K\) y \(L_{2} / K\) dos extensiones admisibles. Esta claro que si \(L_{1} = K(\alpha_{1},\ldots ,\alpha_{n})\), entonces \(L_{2}L_{1} = L_{2}(L_{1}) = L_{2}(\alpha_{1},\ldots ,\alpha_{n})\), lo que muestra que las clases de extensiones finitamente generadas y de extensiones simples son ambas cerradas para extensiones. Por otro lado si \(L_{1} / K\) es algebraica, entonces todo elemento de \(L_{1}\) es algebraico sobre \(K\) y por tanto también sobre \(L_{2}\), lo que implica que \(L_{1}L_{2} = L_{2}(L_{1})\) es algebraico sobre \(K\), por el Corolario 1.17. Esto prueba que la clase de extensiones algebraicas es cerrada para levantamientos. Como una extensión es finita si y solo si es algebraica y finitamente generada (Proposición 1.12) deducimos que la clase de extensiones finitas también es cerrada para levantamientos.
\end{proofbox}

Recuérdese que todo endomorfismo de una extensión finita ha de ser un automorfismo (Proposición 1.3). Esta propiedad se verifica de hecho para toda extensión algebraica.
...
\begin{proofbox}
Sea \(\sigma\) un \(K\)-endomorfismo de \(L\). Como todo homomorfismo de cuerpos es inyectivo, solo hay que probar que \(\sigma\) es suprayectivo. Sea \(\alpha \in L\) y sean \(p = \mathrm{Min}_K(\alpha)\), \(\alpha = \alpha_1, \alpha_2, \ldots , \alpha_n\) las raíces de \(p\) en \(L\). Del Lema 1.8 se deduce que \(\sigma\) permuta \(\{\alpha_1, \ldots , \alpha_n\}\) y por tanto \(\alpha = \sigma (\alpha_i)\) para algún \(i\).
\end{proofbox}