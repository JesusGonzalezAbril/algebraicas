...
% Sean \(K\) un cuerpo y \(P\) un conjunto de polinomios no constantes de \(K[X]\). Se llama \textit{cuerpo de descomposición} de \(P\) sobre \(K\) a un cuerpo de la forma \(K(S)\) donde \(S\) es el conjunto de las raíces de los elementos de \(P\) en una clausura algebraica de \(K\).
% \end{definition}
